...
router.post('/signup', [
  ...
  res.status(200).json({"message":"Account successfully created","token":token})
...
router.post('/login', [
  ...
  if (requestedUser.password === crypto.createHash('md5').update(req.body.password).digest('hex')){
