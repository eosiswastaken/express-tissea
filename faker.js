  ...
  const lines = await prisma.line.createMany({
    data: [
      ...
      },
      {
        name: "28",
        categoryId: 3,
        firstDeparture: "06:21",
        lastDeparture: "23:25",
      },
      {
        name: "29",
        categoryId: 3,
        firstDeparture: "05:55",
        lastDeparture: "00:14",
      },
      {
        name: "30",
...
async function create_stops(lines) {
  const stopsData = [
    ...
    { name: "HB", order: 3, lineId: 1, lat: 47.378, long: 8.54 },
    ...
    { name: "HB", order: 1, lineId: 2, lat: 47.378, long: 8.54 },
    { name: "Kreis 4", order: 2, lineId: 2, lat: 47.38, long: 8.528 },
    ...
    { name: "Bellevue", order: 5, lineId: 3, lat: 47.374, long: 8.54 },
    { name: "Opera", order: 6, lineId: 3, lat: 47.3775, long: 8.543 },
    { name: "Limmatquai", order: 7, lineId: 3, lat: 47.38, long: 8.544 },
    ...
    { name: "Tramstrasse", order: 4, lineId: 4, lat: 47.39, long: 8.516 },
    ...
    { name: "HB", order: 1, lineId: 6, lat: 47.378, long: 8.54 },
    { name: "Kreis 5", order: 2, lineId: 6, lat: 47.384, long: 8.52 },
    ...
    { name: "Schaffhauserplatz", order: 1, lineId: 7, lat: 47.392, long: 8.52 },
    { name: "Kloten", order: 2, lineId: 7, lat: 47.448, long: 8.56 },
    ...
    { name: "HB", order: 5, lineId: 11, lat: 47.378, long: 8.54 },
    { name: "Kreis 4", order: 6, lineId: 11, lat: 47.38, long: 8.528 },
    ...
    { name: "Tramstrasse", order: 3, lineId: 12, lat: 47.39, long: 8.516 },
    ...
    { name: "Zürichsee", order: 7, lineId: 12, lat: 47.35, long: 8.545 },
    ...
    { name: "Kloten", order: 6, lineId: 13, lat: 47.448, long: 8.56 },
    { name: "Zurich Nord", order: 7, lineId: 13, lat: 47.4205, long: 8.528 },

    { name: "Bellevue", order: 1, lineId: 14, lat: 47.374, long: 8.54 },
    { name: "Limmatquai", order: 2, lineId: 14, lat: 47.38, long: 8.544 },
    { name: "HB", order: 3, lineId: 14, lat: 47.378, long: 8.54 },
