...
async function create_lines(categories) {
    const lines = await prisma.line.createMany({
        data: [
            { name: "A", categoryId: categories.find(category => category.name === "Metro")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "B", categoryId: categories.find(category => category.name === "Metro")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "C", categoryId: categories.find(category => category.name === "Metro")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "T1", categoryId: categories.find(category => category.name === "Tramway")?.id, categorySlug: categories.find(category => category.name == "Tramway")?.slug },
            { name: "T2", categoryId: categories.find(category => category.name === "Tramway")?.id, categorySlug: categories.find(category => category.name == "Tramway")?.slug },
            { name: "27", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "28", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "29", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "30", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "31", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "32", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "33", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "34", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug },
            { name: "35", categoryId: categories.find(category => category.name === "Bus")?.id, categorySlug: categories.find(category => category.name == "Metro")?.slug }
        ]
    })
